...
VALUES 
('duy', '123', 'duy Doe', '123 Main St', '1234567890', 1),
('johndoe', 'pass123', 'John Doe', '123 Main St', '1234567890', 1),
('janesmith', 'pass456', 'Jane Smith', '456 Elm St', '9876543210', 1),
('davidjohnson', 'pass789', 'David Johnson', '789 Oak St', '5555555555', 0),
('emilydavis', 'passabc', 'Emily Davis', '321 Pine St', '7777777777', 0),
('michaelwilson', 'passdef', 'Michael Wilson', '567 Maple Ave', '8888888888', 1),
('sarahbrown', 'passghi', 'Sarah Brown', '890 Walnut Blvd', '2222222222', 1),
('jessicataylor', 'passjkl', 'Jessica Taylor', '432 Cedar Ln', '3333333333', 0),
('andrewclark', 'passmno', 'Andrew Clark', '876 Birch Rd', '4444444444', 0),
('oliviaparker', 'passpqr', 'Olivia Parker', '654 Spruce Dr', '9999999999', 1),
('danieladams', 'passtu', 'Daniel Adams', '987 Pineapple Ave', '6666666666', 1);

-- Insert data into the Orders table
INSERT INTO [dbo].[Orders] ([CustomerID], [OrderDate], [RequiredDate], [ShippedDate], [ShipAddress])
VALUES 
(1, '2023-06-01', '2023-06-05', '2023-06-03', '123 Main St'),
(1, NULL, NULL, NULL, '123 Main St'),
...
VALUES 
('Supplier1', '123 Supplier St', '1111111111'),
('Supplier2', '456 Supplier Ln', '2222222222'),
('Supplier3', '789 Supplier Rd', '3333333333');
